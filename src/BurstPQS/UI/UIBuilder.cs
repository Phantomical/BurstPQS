...
internal static class UIBuilder
{
    ...
    internal static GameObject CreateTitleBar(
        Transform parent,
        string title,
        GameObject windowGo,
        UISkinDef skin,
    ...
    )
    {
        ...
        // Close button
        var closeGo = hideOnClose
            ? CreateHideButton(titleBarGo.transform, windowGo)
            : CreateCloseButton(titleBarGo.transform, windowGo);
    ...
    internal static GameObject CreateCloseButton(
        Transform parent,
        GameObject target,
        string text = "X",
        float fontSize = 12
    ...
    internal static GameObject CreateHideButton(
        Transform parent,
        GameObject target,
        string text = "X",
        float fontSize = 12
    )
    {
        ...
        var hideBtn = go.AddComponent<HideButton>();
        hideBtn.button = go.GetComponent<Button>();
        hideBtn.target = target;
