...
{
    [BurstCompile]
    public struct KopernicusPalette4(CPUTexture2D.KopernicusPalette4 texture, MapSO.MapDepth depth)
        : IMapSO
    {
        FormatMapSO<CPUTexture2D.KopernicusPalette4> mapSO = new(texture, depth);
