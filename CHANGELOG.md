...
## Unreleased
### Fixed
* Removed the ambiguous Parallax `KSPAssemblyDependency` from the Parallax
  Continued integration assembly so original Parallax does not satisfy the
  dependency for an assembly that references `ParallaxContinued.dll`.
